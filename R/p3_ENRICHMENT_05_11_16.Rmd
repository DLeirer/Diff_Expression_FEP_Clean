...
enrichments = userListEnrichment(all_probes$TargetID,all_probes$Groups,fnIn=c("Kegg2016.csv"),catNmIn=c("KEGG_2016"),useBloodAtlases=F,useBrainLists=T, useImmunePathwayList=T)
...
write.csv(as.data.frame(enpvDT),file="Supplementary_Table_9_User_list_enrichment_diff_expression_results.csv",row.names=F)
